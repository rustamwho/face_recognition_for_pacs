...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1720, 877)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.open_button = QtWidgets.QPushButton(self.centralwidget)
        self.open_button.setGeometry(QtCore.QRect(1450, 720, 241, 91))
        font = QtGui.QFont()
        ...
        self.close_button.setGeometry(QtCore.QRect(1150, 720, 241, 91))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 40, 1111, 531))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 580, 551, 251))
        ...
        self.logged_in_name_label.setGeometry(QtCore.QRect(1230, 300, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.logged_in_time_label.setGeometry(QtCore.QRect(1230, 350, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.logged_in_image_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.logged_in_image_label_2.setGeometry(QtCore.QRect(1460, 40, 200, 250))
        self.logged_in_image_label_2.setStyleSheet("background-color: rgb(197, 197, 197);")
        self.logged_in_image_label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.logged_in_image_label_2.setObjectName("logged_in_image_label_2")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(600, 580, 201, 251))
        ...
        self.count_logged_in_label.setGeometry(QtCore.QRect(1300, 440, 111, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.count_logged_in_label.setFont(font)
        self.count_logged_in_label.setObjectName("count_logged_in_label")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(1160, 440, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(1160, 470, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.count_logged_out_label = QtWidgets.QLabel(self.centralwidget)
        self.count_logged_out_label.setGeometry(QtCore.QRect(1300, 470, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logged_in_image_label_2.setText(_translate("MainWindow", "Последний вышедший"))
        ...
        self.restart_recognition_action.setText(_translate("MainWindow", "Перезапустить распознование"))
